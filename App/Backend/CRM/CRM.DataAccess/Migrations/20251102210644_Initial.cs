    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubPayment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubPayment_ClubEnrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "ClubEnrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ParentEntityPupilEntity",
                columns: table => new
                {
                    ParentsId = table.Column<Guid>(type: "uuid", nullable: false),
                    PupilsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParentEntityPupilEntity", x => new { x.ParentsId, x.PupilsId });
                    table.ForeignKey(
                        name: "FK_ParentEntityPupilEntity_Parents_ParentsId",
                        column: x => x.ParentsId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParentEntityPupilEntity_Pupils_PupilsId",
                        column: x => x.PupilsId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c456eaea-e6b6-4554-8cc0-33f0d0491ead"), 0, "3ab2b978-55f8-42e4-9c76-092a5a567029", null, null, false, false, null, null, null, "$2a$11$OImh9pA1nRKgoZA/AQBbqO9MFAM5XSoDjVUeQiRFhvg68ZkprUVqG", null, false, "Admin", null, null, false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubPayment_EnrollmentId",
                table: "ClubPayment",
                column: "EnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ParentEntityPupilEntity_PupilsId",
                table: "ParentEntityPupilEntity",
                column: "PupilsId");
